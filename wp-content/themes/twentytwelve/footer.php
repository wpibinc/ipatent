...
<div class="wrapper">
	...
	<div style="margin: 0 auto; width: 940px; height: 25px; font-size: 11px;" >
		<div class="right">
		<span style="float: left;" ><?php if (ICL_LANGUAGE_CODE=='he') {?>כל הזכויות שמורות, ארליך ופנסטר |<?php } else {?>All Rights Reserved, EHRLICH & FENSTER | <?php }?><a href=<?php if (ICL_LANGUAGE_CODE=='he') {?>"http://www.ipatent.co.il/?page_id=1652"<?php } else {?>"http://www.ipatent.co.il/?page_id=1644"<?php }?>><?php if (ICL_LANGUAGE_CODE=='he') {?>תקנון ותנאים<?php } else {?>Terms and Conditions <?php }?></a></span>
