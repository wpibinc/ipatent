			...
			<div class="right team-page-right">
				...
				<div class="right-img">
					...
					<div class="right-details">
                        ...
                        <?php if (types_render_field( "email")) {?><div class="lbl mail-block"><?php if (ICL_LANGUAGE_CODE=='he') {?>מייל:<?php } else {?>Mail:<?php }?><a href="<?php echo "mailto:"; echo(get_post_meta($post->ID, "wpcf-email",true)); echo "@ipatent.co.il"; ?>" target="_blank"><?php echo(get_post_meta($post->ID, "wpcf-email",true)); echo "@ipatent.co.il"; ?></a></div><?php } ?>
